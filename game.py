...
wn.title("Space Station Defense Game by Suhitha")
wn.bgcolor("black")
wn.bgpic(r"C:\Users\DELL\Desktop\project 1\background.gif")
wn.tracer(0)
...
player.color("white")
player.shape("player")
player.speed_value = 20  # Speed variable
player.score = 0
...
def move_forward():
    player.fd(player.speed_value)


def move_backward():
    player.bk(player.speed_value)
...
while True:
    ...
    if Game_Over:
        ...
        for a in asteroids:
            a.hideturtle()
        pen.clear()
        wn.bgpic(r"C:\Users\DELL\Desktop\project 1\end.gif")
        break
